  ...
  const pricingTiers: PricingTier[] = [
    {
      ...
      monthlyPrice: 12,
      duration: "month",
      planId: "P-12V23304WY318440JM4UGEVI", // Plan ID for Monthly
      buttonText: "Sign up now",
      popular: false,
      inverse: true,
      planType: "recurring", // Add planType
      name: "Monthly Plan", // Add name
      description: "This is the monthly subscription plan", // Add description
      features: [
    ...
    },
    {
      ...
      monthlyPrice: 144,
      duration: "year",
      planId: "P-3301733910084232XM4UMAEQ", // Plan ID for Yearly
      buttonText: "Sign up now",
      popular: true,
      inverse: false,
      planType: "recurring", // Add planType
      name: "Yearly Plan", // Add name
      description: "This is the yearly subscription plan", // Add description
      features: [
          ...
          ({
            ...
            >
              ...
              <PaypalSubscriptionButton
                planId={planId} // Pass unique plan ID for each plan
                userId={currentUser.id} // Use current user's ID
                // buttonText={buttonText}  // Button text
                amount={monthlyPrice.toString()} // Pass amount
                currency="USD"
                planType={planType} // Added planType
