...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden fixed overflow-y-auto inset-0 z-50 outline-none focus:outline-none bg-[#fffbf0]">
        <div className="relative bg-transparent w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto bg-[#fffbf0]">
          ...
          >
            <div className="translate h-full lg:h-auto md:h-auto border-0 shadow-lg relative flex flex-col w-full outline-none focus:outline-none rounded-lg">
